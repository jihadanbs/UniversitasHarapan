...
<head>
    ...
    <title>Universitas Harapan > About</title>
                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>00 11 77 88
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>universitasharapan@gmail.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Bandar Lampung, Lampung, INA. 35111
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-7">
                ...
                <p>Hal ini seiring dengan penguasaan teknologi untuk dimanfaatkan sebaik mungkin,
                  ...
                  kami mengejewantahkan nilai-nilai pendidikan yang tertuang dalam visi misi Universitas Harapan,
                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <p class="quote_text">Universitas Harapan benar-benar mengagumkan. Saya sangat senang bisa belajar di Universitas paling keren dan menjadi mahasiswa terbaik tahun 2020.</p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/student-1.png'?>" class="img-fluid" alt="#">
                                <p><span>Abiyasa Binar</span>Mahasiswa Terbaik 2020</p>
                            </div>
                        </div>
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text">Universitas Harapan sangat membantu saya berkembang. Saya sangat senang bisa menempuh pendidikan disana. </p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/student-2.png'?>" class="img-fluid" alt="#">
                                <p><span>Valensia Alfinanda</span>Alumni Angkatan 2021</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="foot-logo">
                            ...
                            <p><?php echo date('Y');?> © copyright by <a href="http://localhost/UniversitasHarapan/" target="_blank">Universitas Harapan</a>. <br>All rights reserved.</p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="sitemap">
                        ...
                        <div class="col-md-3">
                            <div class="address">
                                <h3>Hubungi Kami</h3>
                                <p><span>Alamat: </span> Bandar Lampung, Lampung, INA. 35111</p>
                                <p>Email : universitasharapan@gmail.com
                                    <br> Phone : +62 882-1517-8312</p>
