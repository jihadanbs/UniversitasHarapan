...
<head>
    ...
    <title>Universitas Harapan > Welcome </title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>Pengajar Bekualitas Tinggi</h1>
                            <h4>Pengajar merupakan faktor penting dalam proses belajar-mengajar.<br> Itulah kenapa kami mendatangkan pengajar <br>terbaik dari berbagai penjuru.</h4>
                            <div class="slider-btn">
...
<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
               <h2>Welcome</h2>
               <p>Kami Menyambut baik terbitnya Website UNIVERSITAS HARAPAN yang baru , dengan harapan dipublikasinya website ini sekolah berharap : Peningkatan layanan pendidikan kepada mahasiswa, orangtua, dan masyarakat pada umumnya semakin meningkat. </p>
